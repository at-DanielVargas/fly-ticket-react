                ...
                <div className='col-xs-4 col-md-3'>
                    <div className='d-flex align-center'>
                        <input
                            ...
                            defaultChecked={state.flightType === 'one-way'}
                            name='flightType'
                            value='one-way'
                            id='one-way'
                        />
                        <label className='check-label' htmlFor='one-way'>
                            sencillo
                        </label>
                    </div>
                    <div className='d-flex align-center'>
                        <input
                            type='radio'
                            onChange={handleControlChange}
                            defaultChecked={state.flightType === 'roundtrip'}
                            name='flightType'
                            value='roundtrip'
                            id='roundtrip'
                        />
                        <label className='check-label' htmlFor='roundtrip'>
                            redondo
                        </label>
                    </div>
                </div>
